#' Create a file with regions, adjusted for rural areas.
#'
#' `create_regions` evaluates which regions that each county belongs to, then uses `rural_overlay` to pinpoint
#' rural tracts.
#'
#' @param create_overlay allows for running only the sp::over function
...
#' @param rural_overlay A rural shapefile.
...
#'
#' @details `rural_overlay` merges block centers with the rural_shapefile,
